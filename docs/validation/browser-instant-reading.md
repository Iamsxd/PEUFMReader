...
- 正文优先按句号、问号、感叹号和分号拆成短语音队列，并按结尾标点插入 80–320 毫秒的句间停顿。
...
- Vitest：8 个测试文件、49 项测试全部通过。
- TypeScript 与 Vite 生产构建通过，离线资源清单成功生成。
- Playwright：桌面 Chromium 1440×900 与 Pixel 7 移动视口各 1 项通过；覆盖朗读入口、设备音色枚举、1.25× 语速、0.9 语调、开始、暂停、继续、停止，以及两页 PDF 自动翻页并继续朗读第二页。
