FROM node:26.5.1-bookworm-slim AS web-build
WORKDIR /src/web
...
RUN apt-get update \
    && apt-get install -y --no-install-recommends ca-certificates tzdata libmobi-tools poppler-utils tesseract-ocr tesseract-ocr-eng tesseract-ocr-chi-sim webp \
